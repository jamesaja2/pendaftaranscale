  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <Link
            className="flex items-center justify-center p-3 mt-3 font-medium text-sm text-brand-500 border border-gray-200 rounded-lg hover:bg-gray-100 dark:border-gray-800 dark:text-brand-400 dark:hover:bg-gray-800"
            href="/notifications"
        >
